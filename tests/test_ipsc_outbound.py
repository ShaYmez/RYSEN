...
from ipsc_const import GROUP_VOICE, VOICE_HEAD, VOICE_TERM, SLOT2_VOICE, TS_CALL_MSK, GV_BURST_TYPE_OFF
...
class TestIpscOutbound(unittest.TestCase):
    ...
    def test_encode_head_round_trip(self):
        ...
        self.assertEqual(outbound[1:5], peer)
    ...
    def test_encode_voice_slot_produces_52_byte_packet(self):
        ...
        outbound = tr.encode(dmrd)
        self.assertIsNotNone(outbound)
        self.assertEqual(len(outbound), 52)
